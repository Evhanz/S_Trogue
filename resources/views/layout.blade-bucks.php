    ...
    <div class="three wide column " id="menu-left">
        <div class="ui vertical menu" id="nav-left">
            ...
            <div class="ui dropdown item pro" >
                ...
                <div class="menu" >
                    <a class="item sub" id="linkModProductos" href="{{ URL::route('proveedoresAll')}}"><i class="cubes icon"></i> Proveedores</a>
                    <a class="item sub"><i class="grid layout icon"></i> Rutas</a>
                    <a class="item sub"><i class="archive icon"></i> Anexo</a>
                </div>
            </div>
            <div class="ui dropdown item pro" >
                Control y Calidad
                <i class="dropdown icon"></i>
                <div class="menu" >
                    <a class="item sub" href="{{ URL::route('getAcopioAll')}}"><i class="file icon" ></i> Registro de  <br>Acopio</a>
                </div>
            </div>
